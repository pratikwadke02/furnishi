...
export const addToolsSiteSettings = (toolsSiteSettings) => API.post('/addToolsSiteSettings', toolsSiteSettings );
export const getToolsSiteSettings = () => API.get('/getToolsSiteSettings');

export const addWorkPhaseSiteSettings = (workPhaseSiteSettings) => API.post('/addWorkPhaseSiteSettings', workPhaseSiteSettings );
export const getWorkPhaseSiteSettings = () => API.get('/getWorkPhaseSiteSettings');