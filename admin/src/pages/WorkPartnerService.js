...
import LongService from '../components/workPartnerService/longService';
import ShortService from '../components/workPartnerService/shortService';
import AddOnService from '../components/workPartnerService/addOnService';
            ...
            <Box>
              <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
                <Tabs value={headTab} onChange={handleHeadTabChange} aria-label="basic tabs example">
                  <Tab label="Long services" {...a11yProps(0)} />
                  <Tab label="Short Services" {...a11yProps(1)} />
                  <Tab label="Add On Services" {...a11yProps(2)} />
                </Tabs>
              </Box>
...
export default WorkPartnerService;
