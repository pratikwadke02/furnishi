...
import { updateWorkPartnerLongServices } from '../../actions/workPartner/longServices';
// components
...
export default function CustomerInformation() {
  ...
  const longServicesData = useSelector(state => state.workPartnerLongService.workPartnerLongServices);
  ...
  const handleOpenModal = (id, name, availability, installationtype, installationArea, lightConnection, floatingShelf) => {
    setOpen(true);
    setlongService({
      ...longService,
      id,
  ...
  const handleSubmit = async (event) => {
    ...
    try{
      await dispatch(updateWorkPartnerLongServices(longService));
      setOpen(false);
    } catch (error) {
          ...
          <Box sx={{ width: '100%', mt: 3 }}>
            ...
            <Box sx={{ display: 'flex', flexDirection: { xs: 'column', md: 'row' }, mb: 2 }}>
              ...
              <TextField
                ...
                value={longService.installationArea}
                onChange={handleChange}
              />
              <TextField
                required
          ...
          <Table>
            ...
            <TableBody>
              {longServicesData.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((custInfo, index) => {
                const { id, name, availability, installationtype, installationArea, lightConnection, floatingShelf } =
                  custInfo;
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell align="left">{installationArea}</TableCell>
                    ...
                    <TableCell align="right">
                      <Button
                        variant="contained"
                        onClick={() => handleOpenModal(id, name, availability, installationtype, installationArea, lightConnection, floatingShelf)}
                      >
                        Update
                      </Button>
                    </TableCell>
