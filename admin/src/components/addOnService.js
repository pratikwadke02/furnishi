...
import { updateAddOnServices } from '../actions/addOnService';
// mock
...
export default function AddOnService() {
  const addOnServiceData = useSelector((state) => state.addOnService.addOnServices);
  ...
  const handleSubmit = async(e) => {
    e.preventDefault();
    try{
      await dispatch(updateAddOnServices(addOnService));
      setOpen(false);
    } catch (error) {
