...
import { updateShortServices } from '../actions/shortServices';
// mock
...
export default function ShortServices() {
  const shortServiceData = useSelector((state) => state.shortService.shortServices);
  ...
  const handleSubmit = async(e) => {
    e.preventDefault();
    try{
      await dispatch(updateShortServices(shortService));
      setOpen(false);
    } catch (error) {
